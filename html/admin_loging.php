...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM gateway_admins WHERE A_username='$A_username'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($password == $row['password']) {
            ...
            header("Location: admin_gateway.php");
            exit();
        } else {    
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <center><h4 class="mb-2">ADMIN</h4></center>
              

              <form action="admin_loging.php" method="POST">
                <div class="mb-3">
                  ...
                  <input
                    ...
                    id="email"
                    name="A_username"
                    placeholder="Enter your A_username"
                    autofocus />
                </div>
