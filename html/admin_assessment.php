...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Set status to "active" for new assessment
    $status = "active";

    // Insert data into database
    $sql = "INSERT INTO assessment_schedule (title, type, date, year_section, status) VALUES ('$title', '$type', '$date', '$year_section', '$status')";
