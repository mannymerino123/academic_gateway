...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $year_section = $section; // Changed variable name to remove special characters

    // Insert data into database
    $sql = "INSERT INTO learningmaterials (title, description, google_drive_link, year_section) VALUES ('$title', '$description', '$google_drive_link', '$year_section')";

    if (mysqli_query($conn, $sql)) {
        echo "Learning material inserted successfully!";
    } else {
...
<html
  ...
  <body>
    ...
    <div class="form-group">
        <label for="google_drive_link">Google Drive Link:</label><br>
