              ...
              <div class="position-absolute top-20 start-50 translate-middle">
                <img src="image/SLSU_LOGO.png " alt="Assessment Image" class="img-fluid" style="max-width: 100%; max-height: 100%; margin-left: 200px;margin-bottom: 45px;">
                      ...
                      <div class="row">
                          ...
                          $sql = "SELECT * FROM class_schedule WHERE year_section = '$section' AND status = 'active' ORDER BY STR_TO_DATE(date, '%Y-%m-%d') ASC";
                          ...
                          if (mysqli_num_rows($result) > 0) {
                              ...
                              while ($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // Check if the class_schedule is expired
                                  if (time() > $expiration_timestamp) {
                                      // Update status to 'expired' in the database
                                      $update_sql = "UPDATE class_schedule SET status = 'expired' WHERE id = " . $row['id'];
                                      mysqli_query($conn, $update_sql);
                                      
                                      // Skip this class_schedule as it is expired
                                      continue;
                                  }
                                  ...
                                  <div class="col-md-12">
                                      <div class="material-box text-dark" style="background-color:#00bfff; height: 175px;">
                                          ...
                                          <p style="color: black; "><b><?php echo strtoupper($row['type_class']); ?></b></p>
                                          <h3 style="color: black;"><b><?php echo $row['subject']; ?></b></h3>
                                      </div>
                                  </div>
                                  <?php
                              }
