...
// Check if admin_id session variable is set, if not, redirect to login page
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <a href="q_admin_cashier.php" class="btn btn-secondary">VIEW MORE</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <a href="q_admin_registrar.php" class="btn btn-secondary">VIEW MORE</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <a href="q_admin_sas.php" class="btn btn-secondary">VIEW MORE</a>
                    </div>
                  </div>
                </div>
