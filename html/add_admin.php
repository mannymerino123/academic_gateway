...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['A_username']) && isset($_POST['password']) && isset($_POST['section'])) {
        // Get form data
        ...
        $sql = "INSERT INTO gateway_admins (A_username, password, section ,pin) VALUES ('$A_username', '$password', '$section','$pin')";
...
<html
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="position-absolute top-20 start-50 translate-middle">
                <img src="image/SLSU_LOGO.png " alt="Assessment Image" class="img-fluid" style="max-width: 100%; max-height: 100%; margin-left: 200px;margin-bottom: 45px;">
                      ...
                      <form action="add_admin.php" method="POST" required>
    <div class="mb-3" required>
        <label for="A_username" class="form-label">ADMIN username</label>
        <input type="text" class="form-control" id="A_username" name="A_username" placeholder="Enter your ADMIN username" autofocus required>
    </div>
    <div class="mb-3" required>
        <label for="section" class="form-label">SECTION</label>
        <input type="text" class="form-control" id="email" name="section" placeholder="Enter your SECTION" required>
    </div>
    <div class="mb-3 form-password-toggle" required>
    ...
    <div class="mb-3" >
        <label for="section" class="form-label">ADMIN PIN</label>
    ...
    <button class="btn btn-primary d-grid w-100" required>Sign up</button>
</form>
