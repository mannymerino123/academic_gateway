<?php
  ...
  $expiredQueueSql = "UPDATE q_registrar SET status = 'expired', num_attempts = '0' WHERE s_stat = 'served' AND status = 'expired'  AND time <= DATE_SUB('$dateTimeNow', INTERVAL 720 MINUTE)";
  ...
  $sqlserved = "SELECT MAX(priority_queue_number) AS max_queues FROM q_registrar WHERE student_ID = '$studentID' AND status = 'active' AND s_stat ='waiting'";
  ...
  $Sqlnext = "SELECT MIN(priority_queue_number) AS MINIMUM FROM q_registrar WHERE status = 'active' AND s_stat ='waiting'";
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <form style="text-align: center;" action="q_registrar_function.php" method="post">
