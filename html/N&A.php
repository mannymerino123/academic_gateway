...
<html
  ...
  <head>
    ...
    <title>NAVIGATION AND APPOINTMENT</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                ...
                <img src="image/NA.jpg" alt="Image" style="width: 100%; height: auto;">
                </div>
            </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 order-0 mb-4">
                    <div class="card h-50">
                        <a href="nav_registrar.php">
                            <img class="card-img-top" src="image/registrar.jpg" alt="Card image cap" />
                        </a>
                    </div>
                </div>
                <div class="col-md-2 col-lg-2 col-xl-2 order-0 mb-4">
                    <div class="card h-50">
                        <a href="nav_cashier.php">
                            <img class="card-img-top" src="image/cashiers.jpg" alt="Card image cap" />
                        </a>
                    </div>
                </div>
                <div class="col-md-2 col-lg-2 col-xl-2 order-0 mb-4">
                    <div class="card h-50">
                        <a href="nav_igp.php">
                            <img class="card-img-top" src="image/IGP.jpg" alt="Card image cap" />
                        </a>
                    </div>
                </div>
                <div class="col-md-2 col-lg-2 col-xl-2 order-0 mb-4">
                    <div class="card h-50">
                        <a href="nav_sas.php">
                            <img class="card-img-top" src="image/sas.jpg" alt="Card image cap" />
                        </a>
                    </div>
                </div>
                <div class="col-md-2 col-lg-2 col-xl-2 order-0 mb-4">
                    <div class="card h-50">
                        <a href="nav_guidance.php">
                            <img class="card-img-top" src="image/guidance.jpg" alt="Card image cap" />
                        </a>
                    </div>
                </div>
                <div class="col-md-2 col-lg-2 col-xl-2 order-0 mb-4">
                    <div class="card h-50">
                        <a href="nav_ssc.php">
                            <img class="card-img-top" src="image/scc.jpg" alt="Card image cap" />
                        </a>
                    </div>
                </div>
